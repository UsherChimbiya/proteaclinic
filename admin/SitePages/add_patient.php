                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <ul class="list-unstyled">
                                                ...
                                                <form method="post" action="submit_patients.php">
                                                   
                                                    <input type="text" name="p_name" placeholder="Full Name"><br><br>
                                                    <input type="text" name="age" placeholder="Age"><br><br>
                                                    <input type="text" name="p_sickness" placeholder="Diagnosis"><br><br>
                                                    <input type="text" name="date_of_birth" placeholder="Date Of Birth"><br><br>
                                                    <input type="text" name="doctor_name" placeholder="Appointed Doctor"><br><br>
