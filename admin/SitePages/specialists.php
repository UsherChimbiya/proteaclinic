                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown dropleft"><a class="nav-link notification-dropdown" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="badge badge-pill badge-primary" style="float:right;margin-bottom:-10px;"></span><i class="las la-bell"></i></a>
                        <div class="dropdown-menu notification-dropdown-menu shadow-lg" aria-labelledby="notification-dropdown">
                            <div class="dropdown-title"><a href="">Appointments<span class="ml-2 notifications-count">(3)</span></a><a class="float-right" href="">mark all as read</a></div>
    ...
    <main>
        ...
        <div class="main-content">
                ...
                <div class="section filters-section justify-content-between">
                    <div class="dropdowns-wrapper">
                        <div class="dropdown"><a class="btn btn-dark-red-o dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">filter</a>
                            <div class="dropdown-menu shadow-lg" aria-labelledby="dropdownMenuLink"><a class="dropdown-item" href="#">name</a><a class="dropdown-item" href="#">gender</a><a class="dropdown-item" href="#">specialization</a><a class="dropdown-item" href="#">email</a><a class="dropdown-item" href="#">phone no.</a>
                    ...
                    <div class="buttons-wrapper">
                        <a href="specialists_form.php"> <button class="btn btn-dark-red-f-gr"><i class="las la-plus-circle"></i>add a new specialist</button></a>
                    </div>
                </div>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><img class='rounded-circle' src='../SiteAssets/images/people.svg' loading='lazy' /><span class='ml-2'>" . $row['gender'] . "</span></td>";
                echo "<td>" . $row['proffesional'] . "</td>";
                echo "<td>" . $row['email'] . "</td>";
                echo "<td>" . $row['phone_number'] . "</td>";
                echo "<td><label class='label-" . $row['address'] . "'>" . $row['address'] . "</label></td>";
                                ...
                                <div class="carousel slide" id="carouselExampleCaptions" data-ride="carousel">
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item"><img class="d-block" src="../SiteAssets/images/undraw_receipt_ecdd.svg" alt="..." />
                                            <div class="carousel-caption d-md-block">
                                                <p>simple<a href="procurement.php">Procurement<i class="las la-external-link-alt"></i></a>process</p>
                                            </div>
                                        </div>
                                        <div class="carousel-item"><img class="d-block" src="../SiteAssets/images/undraw_new_notifications_fhvw.svg" alt="..." />
                                            <div class="carousel-caption d-md-block">
                                                <p>comprehensive<a href="notifications.php">Notification<i class="las la-external-link-alt"></i></a>center</p>
                                            </div>
                                        </div>
                                        <div class="carousel-item"><img class="d-block" src="../SiteAssets/images/undraw_Preferences_re_49in.svg" alt="..." />
                                            <div class="carousel-caption d-md-block">
                                                <p>Minimalist<a href="settings.php">Settings<i class="las la-external-link-alt"></i></a>center</p>
                                            </div>
                                        </div>
