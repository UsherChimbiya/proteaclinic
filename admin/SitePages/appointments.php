...
<body>
    ...
    <main>
        <div class="side-nav">
            <ul class="list-group list-group-flush"><a class="list-group-item" href="dashboard.php" data-toggle="tooltip" data-placement="bottom" title="Dashboard"><i class="las la-shapes la-lw"></i><span>dashboard</span></a><a class="list-group-item" href="patients.html" data-toggle="tooltip"
                ...
                <a class="list-group-item" href="procurement.html" data-toggle="tooltip" data-placement="bottom" title="Procurement"><i class="las la-shopping-cart la-lw"></i><span>procurement</span></a><a class="list-group-item" href="appointments.php"
                    data-toggle="tooltip" data-placement="bottom" title="Appointments"><i class="las la-sms la-lw"></i><span>Appointments</span></a>
            ...
            <div class="container-fluid">
                <div class="section title-section">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="create_procurement.php"> <button class="btn btn-dark-red-f-gr"><i class="las la-plus-circle"></i>create a request</button></a>
                        </div>
                    </div>
                </div>
                <div class="section filters-section">
                    <div class="row">
                        <div class="col-lg-8 col-md-6"><button class="btn btn-dark-red-o mr-2"><i class="las la-filter"></i>filter</button><button class="btn btn-dark-red-o"><i class="las la-sort"></i>sort</button></div>
                        <div class="col-lg-4 col-md-6">
                            <div class="input-group">
                                <div class="input-group-prepend"><span class="input-group-text"><i class="las la-search"></i></span></div><input class="form-control" placeholder="search by title, owner, or vendor" /></div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table table-hover table-responsive-lg">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                ...
                                echo "<tr>";
                                ?>
                                <form method="post" action="appointments_approval.php">
                                    <?php
                                echo "<td>" . $row['id'] . "</td>";
                                echo "<td>" . $row['name'] . "</td>";
                                ...
                                echo "<td>";
                                  if ($row['status'] == "Pending"){
                                    ?>  
                                        ...
                                        <a class='view-more btn btn-sm btn-dark-red-f' href="approve_form.php"> Approve </a>
                                    </form>  
                                    <?php
                                } else {
                                    echo '<b><P class="view-more btn btn-sm btn-dark-blue-f">' . $row['status'] . '</b>'; 
                                }
                                echo "</td></tr>";
                            }
                            ?>
