                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <ul class="list-unstyled">
                                                ...
                                                <form method="post" action="add_procurement.php">
                                                   
                                                    <input type="text" name="item_name" placeholder="Name of Item"><br><br>
                                                    <input type="text" name="quantity" placeholder="Quantity"><br><br>
                                                    <input type="text" name="requested_by" placeholder="Requested By?"><br><br>
