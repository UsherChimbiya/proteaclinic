                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <ul class="list-unstyled">
                                                ...
                                                <form method="post" action="appoint_approve.php">
                                                   
                                                    <input type="text" name="p_name" placeholder="Patient Name"><br><br>
                                                    <input type="text" name="p_sickness" placeholder="phone_number"><br><br>
                                                    <input type="text" name="doctor_name" placeholder="Assigned Doctor"><br><br>
                                                    <input type="text" name="appointed_time" placeholder="Appointed Time"><br><br>
